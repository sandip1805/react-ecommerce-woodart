                                    ...
                                    {userOrder.map((item,index)=>{
                                        return(
                                            <tr className="bg-white dark:bg-slate-900 text-start" key={index}>
                                                ...
                                                <td className="px-2 py-3 text-start"><Link to="#" className="text-orange-500">View <i className="mdi mdi-chevron-right"></i></Link></td>
                                            </tr>
                                        )
                                    })}
                                </tbody>
                                    ...
                                    return(
                                        <li className="flex justify-between items-center py-6 border-t first-of-type:border-0 border-gray-100 dark:border-gray-700" key={index}>
                                            <div className="flex items-center">
                                                ...
                                                <div className="ms-4">
                                                    <Link to="" className="font-semibold hover:text-orange-500">Ladies Top</Link>
