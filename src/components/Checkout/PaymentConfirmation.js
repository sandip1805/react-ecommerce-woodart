            ...
            <Card className='lg:p-12 p-6 login_register_shadow lg:mt-20 flex justify-center'>
                <div className="flex items-center justify-center">
                    <div className="flex flex-col items-center justify-center rounded-lg">
                        ...
                        <p className="text-5xl md:text-7xl lg:text-5xl font-bold tracking-wider pt-10 text-black">Confirmed!!!</p>
                        <p className="text-center text-xl md:text-3xl lg:text-xl font-bold tracking-wider pt-4 text-black">Thank you for purchase</p>
                        <Link to={'/products'}>
