...
import { Link } from "react-router-dom";
  ...
  export function ProductCard({product}) {
    ...
    const handleLikeProduct = () => {
      singleProduct.favourite = !singleProduct.favourite;
      const updatedProduct = JSON.parse(JSON.stringify(singleProduct));
      ...
      <Card className="w-full max-w-[26rem] login_register_shadow">
          ...
          <CardHeader floated={false} color="blue-gray shadow-none" className="lg:mt-4">
            ...
            >
              <svg
                ...
                viewBox="0 0 24 24"
                fill={singleProduct.favourite ? "red" : "white"}
                className="h-6 w-6"
              >
        ...
        <CardBody>
          ...
          <Typography color="gray">
            {(singleProduct && singleProduct.description) ? singleProduct.description : 'Product Name'}
          </Typography>
        </CardBody>
      </Card>
    );
